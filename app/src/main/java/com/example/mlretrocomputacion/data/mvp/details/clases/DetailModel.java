package com.example.mlretrocomputacion.data.mvp.details.clases;
...
Retrieves all the information about ONE item listed in a specific MercadoLibres category -> public List<ItemModel> getResults()
 */
